...
/*
  ...
  문제 설명:
  우주 탐사선을 발사하기 위한 카운트다운을 진행하는 프로그램을 작성합니다. 카운트다운은 10초부터 시작하며, 각 초마다 카운트다운 숫자를 출력합니다. 그러나, 발사 준비 과정 중에 기술적인 문제가 발생할 수 있으며, 문제가 발생하면 카운트다운을 즉시 중단하고 "발사 중단: 기술적 문제 발생!" 메시지를 출력해야 합니다. 문제가 발생하지 않고 카운트다운이 0에 도달하면 "발사 성공!" 메시지를 출력합니다.
