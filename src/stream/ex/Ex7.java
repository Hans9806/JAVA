...
/*
   ...
   영화 평점 정보가 담긴 리스트가 있습니다. 각 평점 정보는 영화의 이름과 평점(1~5)을 포함합니다. 평점이 4 이상인 영화만 필터링하고, 그 결과를 확인하기 위해 peek를 사용하세요. 마지막으로, 평점이 4 이상인 영화의 이름을 알파벳 순으로 정렬하여 최종 목록을 출력하는 프로그램을 작성하세요.
...
public class Ex7 {
    ...
    public static void main(String[] args) {
        ...
        ratings.stream()
                ...
                .peek(movieRating -> System.out.println(movieRating.movieName + ", 평점: "+movieRating.rating))
