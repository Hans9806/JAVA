...
public class Network2 {
    public static void main(String[] args) throws URISyntaxException, MalformedURLException {
        // 문자열로부터 URI 객체 생성
        URI uri = new URI("https://entertain.naver.com/read?oid=076&aid=0004127078");
        ...
        // URL 객체
        URL url = new URL("https://entertain.naver.com/read?oid=076&aid=0004127078");
        // 형식에 맞지 않느느 문자열을 사용할 경우 : MalformedURLException
