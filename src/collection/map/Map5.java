...
public class Map5 {
    public static void main(String[] args) {
        ...
        // 키를 기준으로 자동 정렬
        // Entry 키의 낮은 것은 왼쪽, Entry Kry 높은 것은 오른쪽
        ...
        // 가장 처음의 Entry 반환
        java.util.Map.Entry<String,Integer> firstEntry = treeMap.firstEntry();
        ...
        for (java.util.Map.Entry<String, Integer> entry : descendingMap.entrySet()) {
            System.out.println(entry);
        }

        System.out.println("=======  알파벳 c~h 사이에 있는 맵  =======");
        SortedMap<String,Integer> subMap = treeMap.subMap("c","h");
        for (java.util.Map.Entry<String, Integer> entry : subMap.entrySet()) {
            System.out.println(entry);
        }
    }
}
