...
/*
   ...
   입력예시: 예약 요청 정보(정확한 시작 시간과 종료 시간)
   ===
...
public class Ex6 {
    ...
    public static void main(String[] args) {
        ...
        reservations.add(new Reservation(LocalDateTime.of(2023,10,10,12,0)
                ,"홍길동","회의실"));
        reservations.add(new Reservation(LocalDateTime.of(2023,10,10,10,0)
                ,"김길동","회의실"));
        reservations.add(new Reservation(LocalDateTime.of(2023,10,11,10,0)
                ,"홍길남","회의실"));
        reservations.add(new Reservation(LocalDateTime.of(2023,10,10,15,0)
                ,"홍길서","회의실"));
