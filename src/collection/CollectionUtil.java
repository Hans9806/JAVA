...
public class CollectionUtil {
    public static void main(String[] args) {
        // Collections 클래스 : 다양한 컬력센을 다루기 위해 제공하는 메서드들의 모음
        ...
        // 카피List의 크기(size)가 원본List(size)보다 같거나 커야 복사 가능
        ...
        // replaceAll(List, 이진값, 새값)
        Collections.replaceAll(numberList, 3, 30);
        System.out.println("numberList = " + numberList);

        // swap(List, 인덱스, 인덱스)
        Collections.swap(numberList, 2, 4);
        System.out.println("인덱스 2와 4가 자리 바뀐 numberList = " + numberList);
