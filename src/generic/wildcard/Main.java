...
public class Main {
    public static void main(String[] args) {
        ...
        Applicant<HighSchoolStudent> highSchoolStudentApplicant
                = new Applicant<>(highSchoolStudent);
        Applicant<middleSchoolStudent> middleSchoolStudentApplicant
                = new Applicant<>(middleSchoolStudent);
        // 모두의 과정 : Applicant<?>
