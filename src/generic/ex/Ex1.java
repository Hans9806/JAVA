...
/*
   ...
   문제 설명:
   두 개의 객체를 한 쌍으로 관리할 수 있는 제네릭 클래스 Pair를 구현하세요. 이 클래스는 두 객체의 타입이 서로 다를 수 있도록 제네릭을 활용해야 합니다. Pair 클래스는 두 객체에 대해 getter 메소드를 제공해야 하며, 이 두 객체는 생성 시점에 초기화되어야 합니다.
