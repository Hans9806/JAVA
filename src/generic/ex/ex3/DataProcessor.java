...
/*문제 설명:
제네릭 인터페이스 DataProcessor<T>를 정의하고, 이를 구현하는 클래스를 작성하여 데이터 처리 시스템을 구현합니다. DataProcessor<T> 인터페이스는 데이터를 처리(processData)하고 결과를 반환하는 메소드를 포함해야 합니다. 이 연습 문제를 통해, 제네릭 인터페이스를 사용하여 다양한 타입의 데이터를 처리할 수 있는 유연한 시스템을 구현하는 방법을 배웁니다.
