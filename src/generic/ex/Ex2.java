...
/*
  ...
  문제 설명:
  어떤 배열에서 주어진 요소가 몇 번째 위치에 있는지를 찾는 제네릭 메서드 findIndex를 구현합니다. 이 메서드는 배열과 찾고자 하는 요소를 매개변수로 받고, 요소가 배열 내에 있으면 해당 요소의 인덱스를, 없으면 -1을 반환해야 합니다.
...
public class Ex2 {
    public static <T> int findIndex(T[] array, T element) {
        // 배열과 검색할 요소를 매개변수로 받아,
        // 요소가 배열 내에 있으면 해당 요소의 인덱스를, 없으면 -1을 반환
    ...
    public static void main(String[] args) {
        ...
        int intIndex = findIndex(intArray, 3);
        System.out.println("intArray에서 generic의 인덱스: "+ intIndex);
