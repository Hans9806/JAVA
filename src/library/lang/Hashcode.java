...
public class Hashcode {
    public static void main(String[] args) {
        // Object 클래스의 메모리 주소를 기반으로 함
        // 기본적으로 메모리 주소를 기반으로 한 정수값을 가짐
        // equals() 메서드를 오버라이드 해서 동등성을 비교하는 경우
        // hashcode() 메서드도 함께 오버라이드하여, 동등한 객체가 나오도록 반환해야 함.
        // => 열관성이 중요함
        ...
        // true 면 동등 객체
        // hashCode 는 hash 충돌이 발생할 수 있다 : 서로 다른 입력 값에 대해서 동일한
        // 해시값이 생성되는 경우, 잘 만든 해시함수는 hash 충돌을 최소화하지만 완전히
        // hash 충동이 없을 수는 없다.
