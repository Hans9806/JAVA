...
public class StringMethod3 {
    public static void main(String[] args) {
        ...
        // endsWith : 해당 문자열이 끝나는지 여부
        boolean res12 = str.endsWith("똑똑");
        boolean res13 = str.endsWith("시계");

        // watch : 정규식을 이용하여 매치 되는 여부

        // email 주소 여부를 확인하는 정규식
        String regex = "^[a-zA-Z0-9_+&*-]+(?:\\.[a-zA-Z0-9_+&*-]+)*@(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,7}$";

        String email1 = "normal@examole.com";
        String email2 = "abnormal_examole.com";
        String email3 = "abnormal@examole@com";
