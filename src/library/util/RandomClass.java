...
public class RandomClass {
    public static void main(String[] args) {
        ...
        // 컬렉션 프레임워크를 포함한 여러가지 유용한 클래스들을 포함가고 있다.
        ...
        int diveRangeNum = random.nextInt(1,7);

        // 랜덤한 참 거짓 생성
        boolean trueFalse = random.nextBoolean();
        System.out.println(trueFalse);

        // 시드 값 : 난수 생성의 시작점을 제공하거, 동일한 시드값을 생성된 Random 객체는
        // 동일한 난수를 생성
        ...
        Random random456 = new Random(45912123);
        System.out.println(random456.nextInt(100));

        // 시드 값을 설정하는 이유 : 재현성을 확보하여 디버깅, 테스트를 수행할 때,
        // 동일한 난수 생성으로 용이하게 사용
        // 예측 가능성 : 시뮬레이션 실험 등에서 동일 입력 동일 결과를 얻고자할 때 유용
        // 시드값을 설정하지 않을 때 : System.currentTimeMillis() 또는
        // 유사한 시간 기반 값의 시드를 자동으로 설정한다.
